    ...
    const generateImage = async () => {
        if( form.prompt ) {
            try {
                ...
                alert('Error in generating imnage! Error: ', err)   
            } finally {
    ...
    const handleSubmit = async (e) => {
        ...
        if (form.prompt && form.photo) {
            ...
            try {
                ...
                console.error('Error when sharing to community: ', err)
                alert('Error when sharing to community! Check console for more information.')
            } finally {
                setLoading(false)
            }
        } else {
